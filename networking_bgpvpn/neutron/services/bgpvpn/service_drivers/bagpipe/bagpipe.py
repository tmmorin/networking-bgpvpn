...
from networking_bgpvpn.neutron.services.bgpvpn.service_drivers.bagpipe \
    import rpc_client
...
class BaGPipeBGPVPNDriver(service_drivers.BGPVPNDriver,
    ...
    def _format_bgpvpn_connection(self, bgpvpn_connection):
        """
        Format BGP VPN connection (BGP VPN connection and network identifiers,
        and route targets)
        """
    ...
    def _get_bgpvpn_connection_differences(self, current_dict, old_dict):
        """
        Compare 2 BGP VPN connections as:
